...
class TicketWritebackRecord:
    ...
    error: str | None
    created_at: str
    # R30-B: prompt/model version tracing (spec §6.4).  Optional so the
    # legacy ``record()`` signature keeps working; populated by the RCA
    # pipeline when the report was generated by a known prompt+model.
